# Generated by Django 3.2.10 on 2023-06-22 20:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_endereco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usuario_endereco', to='login.usuario')),
            ],
        ),
        migrations.CreateModel(
            name='ContaBancaria',
            fields=[
                ...
                ('usuario_banco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='banco', to='login.usuario')),
            ],
        ),
    ]
