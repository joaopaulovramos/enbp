    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fornecedor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pessoa_documento_unico', to='cadastro.pessoa')),
                ...
                ('usuario_analise_financeira', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documento_unico_usuario_analise_financeira', to=settings.AUTH_USER_MODEL)),
                ('usuario_analise_fiscal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documento_unico_usuario_analise_fiscal', to=settings.AUTH_USER_MODEL)),
                ('usuario_diretoria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documento_unico_usuario_diretoria', to=settings.AUTH_USER_MODEL)),
                ('usuario_gerencia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documento_unico_usuario_gerencia', to=settings.AUTH_USER_MODEL)),
                ('usuario_superintencencia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documento_unico_usuario_superintendencia', to=settings.AUTH_USER_MODEL)),
            ],
            options={
