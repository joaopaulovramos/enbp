# Generated by Django 3.2.10 on 2023-07-22 16:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('janela_unica', '0003_auto_20230722_1322'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='documentounicofinanceiro',
            name='projeto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='projeto_ju', to='norli_projeto.exemplomodel'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='documentounicofinanceiro',
            name='tipo_anexo',
            field=models.CharField(blank=True, choices=[('0', '.xml'), ('1', '.pdf'), ('2', '.doc'), ('3', 'Outros')], max_length=1, null=True),
        ),
    ]
