...
CUSTOM_PERMISSIONS = ['configurar_nfe', 'emitir_notafiscal', 'cancelar_notafiscal', 'gerar_danfe', 'consultar_cadastro', 'inutilizar_notafiscal', 'consultar_notafiscal',
                      ...
                      'autorizar_viagens_sup', 'autorizar_viagens_dus', 'autorizar_pagamento_diarias', 'autorizar_pagamento_reembolso', 'homologar_viagens', 'homologar_prestacao_de_contas', 'cadastrar_item_viagens', 'aprovar_pc_viagens', 'aprovar_horas', 'analisar_opinioes', ]
